...
public class App extends JFrame implements ActionListener {
    ...
    public App() {
        ...
        lblTotalSalario = new JLabel("Total Salario: $0.00");
        ...
        pnlCentro.add(pnlDatos, BorderLayout.SOUTH);
        add(pnlCentro, BorderLayout.CENTER);
        add(pnlBotones, BorderLayout.SOUTH);
        add(lblTotalSalario, BorderLayout.NORTH); 
    }
    ...
    public void actualizarTotalSalario() {
        double total = 0.0;
        for (Jugador jugador : datos) {
            total += jugador.getSalario(); 
        }
        lblTotalSalario.setText("Total Salario: $" + String.format("%.2f", total));
    }
